...
import { CalendarDateRangePicker } from "@/app/channel/dashboard/components/date-range-picker";
    ...
    <>
      ...
      <div className="hidden flex-col md:flex">
        ...
        <div className="flex-1 space-y-4 p-8 pt-6">
          <div className="flex items-center justify-start space-y-2 space-x-8">
            <h2 className="text-3xl font-bold tracking-tight">Dashboard</h2>
            <TeamSwitcher className="mx-6" />
          </div>
